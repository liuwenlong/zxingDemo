...
public final class PlanarYUVLuminanceSource extends LuminanceSource {
  ...
  public PlanarYUVLuminanceSource rotationData(int width, int height){
	  ...
	  for (int y = 0, rowStart = top * dataWidth + left; y < height; y++, rowStart += dataWidth) {
	      for (int x = 0; x < width; x++ ) {
	         yuvData[x*nWidth+y] = this.yuvData[rowStart+x];
	      }
	  }

	  return new PlanarYUVLuminanceSource(yuvData,nWidth,nHeight,0,0,nWidth,nHeight,false);
